...
public class ItemData {
  ...
  static public <T> IPosOnlyFeedback read(BufferedReader reader, IEntityMapping user_mapping, IEntityMapping item_mapping, boolean ignore_first_line) throws Exception {
    ...
    while ((line = reader.readLine()) != null ) {
      ...
      int user_id = user_mapping.toInternalID(String.valueOf(TwitterIDUtil.getIndex(tokens[0])));      
      int item_id = item_mapping.toInternalID(String.valueOf(TwitterIDUtil.getIndex(tokens[1])));
